...
const products = [
  {
    name: 'images/real_orbis_wash.jpg',
    url: 'https://www.amazon.co.jp/s?k=' + encodeURIComponent('オルビス ミスター フォーミングウォッシュ 洗顔')
  },
  {
    name: 'images/real_orbis_lotion.jpg',
    url: 'https://www.amazon.co.jp/s?k=' + encodeURIComponent('オルビス ミスター エッセンスローション 化粧水')
  },
  {
    name: 'images/real_melanocc.jpg',
    url: 'https://www.amazon.co.jp/s?k=' + encodeURIComponent('メラノCC 薬用しみ 集中対策 プレミアム美容液')
  },
  {
    name: 'images/real_pairacne.jpg',
    url: 'https://www.amazon.co.jp/s?k=' + encodeURIComponent('ペアアクネクリームW 24g ライオン')
  }
];
...
async function main() {
  console.log('Launching Chrome browser (Visible Window) via Puppeteer to browse real product photos...');
